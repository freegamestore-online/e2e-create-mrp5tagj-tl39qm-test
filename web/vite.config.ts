...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-mrp5tagj-tl39qm-test",
        short_name: "Create Canary e2e-create-mrp5tagj-tl39qm-test",
        description: "Create Canary e2e-create-mrp5tagj-tl39qm-test — free forever",
        start_url: "/",
        display: "standalone",
